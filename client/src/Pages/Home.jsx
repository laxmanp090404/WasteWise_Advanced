  ...
  const Home = () => {
    ...
    return (
      ...
      >
        ...
        <section ref={servicesRef} className="w-full bg-white py-20 md:py-32 lg:py-40">
          <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-[#f0f9f0] rounded-lg p-6 flex flex-col items-start gap-4">
                ...
                <h3 className="text-xl font-bold text-[#1a4c1a]">Found Waste Dumpings</h3>
                <p className="text-[#4d7a4d]">
                Take a picture and post to Us. Our AI will categorise the waste and our team will come and collect the waste.              </p>
                <Link
                  to={"/uploadandcollect"}
                  onClick={scrollToTop}
                  className="inline-flex items-center justify-center h-9 px-4 rounded-md bg-[#1a4c1a] text-white font-medium transition-colors hover:bg-[#133313] focus:outline-none focus:ring-2 focus:ring-[#1a4c1a] focus:ring-opacity-50"
